...
public class SetAnimation {
	...
	public static void Rotate(AnimationSet aSet, float fromDegree,
			float toDegree, int pivotXtype, float pivotXvalue, int pivotYtype,
			float pivotYvalue, int iOffset, int iDuration, int repeatCount,
			int repeatMode) {
	...
	public static void Scale(AnimationSet aSet, float fromX, float toX,
			float fromY, float toY, int pivotXtype, float pivotXvalue,
			int pivotYtype, float pivotYvalue, int iOffset, int iDuration,
	...
	public static void Translate(AnimationSet aSet,
	...
	public static void Alpha(AnimationSet aSet, float fromAlpha,
			float toAlpha, int iOffset, int iDuration, int repeatCount, int repeatMode) {
